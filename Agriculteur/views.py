...
def create_farmer(request):
    if request.method == 'POST':
        ...
        Farmer.objects.using('agriculteur').create(sensor_data=sensor_data, parcelle_id=parcelle_id, culture=culture,
                                                   variete=variete,
        ...
        json_data = capteur()
        return render(request, 'agriculteur.html', {'json_data': json_data})
